...
# def answer_joined(client: Client, action_type: str, uid: int, mid: int, key: str, reason: str = None):
#     # Answer joined procedure
#     result = False
#
#     try:
#         result = True
#     except Exception as e:
#         logger.warning(f"Answer joined error: {e}", exc_info=True)
#
#     return result
